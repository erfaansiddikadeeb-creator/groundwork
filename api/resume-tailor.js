...
3. Write a specific, non-generic cover letter (3 short body paragraphs) in the candidate's voice, referencing the actual company/role where possible. It must be a COMPLETE, ready-to-send letter with all of these parts, in this order:
   ...
   - An opening line naming the specific role. ONLY mention how/where the role was found (referral, careers page, job board, etc) if the job posting text explicitly states this — never guess or invent a source. If the posting doesn't say, simply state interest in the role without mentioning how it was discovered.
   ...
   - If the resume contains a second distinct number or result, use it too, ideally in a different paragraph than the first — do not cluster every number into one sentence.
   - Avoid generic filler phrases such as "I am excited to apply," "I have honed my skills," "aligns well with your needs," "passion for X," "I am eager to," "I am confident that," "valuable asset," "hit the ground running," "wear many hats" — write plainly and specifically instead of using stock cover-letter language. If a sentence would read the same for almost any candidate applying to almost any job, rewrite it to be specific to this resume and this posting instead.
   ...
   - Vary sentence length and structure across the three paragraphs — do not open every paragraph the same way (e.g. don't start every paragraph with "I").
   - Keep the tone confident and professional, not falsely enthusiastic — no exclamation points, no superlatives like "thrilled" or "passionate" unless the resume's own tone genuinely supports it.
