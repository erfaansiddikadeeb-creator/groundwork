...
import { FileCheck2, Search, Loader2, Sparkles, RotateCcw, AlertTriangle, Camera, Upload, X, Wand2 } from "lucide-react";
...
This Independent Contractor Agreement ("Agreement") is entered into as of the date of last signature below, by and between Brightline Creative Studio LLC ("Company") and the undersigned freelance designer ("Contractor").

1. SERVICES
Contractor agrees to provide graphic design and branding services to Company, including but not limited to logo design, marketing collateral, and website mockups, as assigned by Company from time to time ("Services"). Company may modify the scope of Services at its sole discretion upon written notice.

2. COMPENSATION
Company shall pay Contractor a rate to be determined per project. Payment shall be issued within a commercially reasonable time following Company's acceptance of deliverables. Company reserves the right to withhold payment, in whole or in part, if Company is not fully satisfied with the quality of the deliverables, as determined by Company in its sole discretion.
...
All work product, designs, concepts, drafts, sketches, source files, and any other materials created by Contractor in connection with this Agreement, whether or not ultimately used by Company, shall be considered "work made for hire" and shall be the sole and exclusive property of Company. Contractor hereby assigns all right, title, and interest in any such materials to Company, including any pre-existing intellectual property incorporated into the deliverables.

5. NON-COMPETE
During the term of this Agreement and for a period of twenty-four (24) months following its termination, Contractor shall not, directly or indirectly, provide design services to any business operating in the creative, marketing, or branding industry within the United States.

6. LIABILITY
Contractor shall indemnify, defend, and hold harmless Company from and against any and all claims, damages, losses, liabilities, costs, and expenses arising out of or related to Contractor's performance under this Agreement, without limitation as to amount.

7. TERMINATION
Company may terminate this Agreement at any time, with or without cause, immediately upon written notice to Contractor. Contractor may terminate this Agreement only upon ninety (90) days' written notice to Company.`;
...
export default function ContractChecker() {
  ...
  async function handleCheck(textOverride) {
    const textToUse = textOverride ?? contractText;
    setLoading(true);
    setError("");
    setResult(null);
    try {
        ...
        <div style={{ flex: 1, minWidth: "320px", padding: "28px 28px 28px 32px" }}>
          <button
            ...
            style={{
              ...
              opacity: loading || compressing ? 0.5 : 1,
              marginBottom: "18px",
              fontFamily: "'Inter', sans-serif",
            }}
          >
