...
export default function Privacy() {
  usePageTitle("Privacy Policy — Fixyorio");
  return (
    <div
      style={{
    ...
    >
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "40px 32px 60px" }}>
        ...
        <div style={{ fontSize: "14.5px", lineHeight: 1.7, color: "var(--graphite)" }}>
          <p>
            Fixyorio ("we", "our", "the site") provides free tools, including a resume tailor
            and a contract checker. This page explains what happens to the information you enter.
          </p>

          <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: "18px", marginTop: "26px" }}>
            What you submit
          </h2>
          <p>
