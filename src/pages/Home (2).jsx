...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      "Paste or upload a freelance or employment contract. Get a plain-English breakdown of what it actually says, and a flagged list of clauses worth a second look.",
    metric: "Risk flags",
  },
  {
    path: "/growth-tracker",
  ...
  },
  {
    ...
    description:
      "Strip hidden EXIF and GPS location data from a photo before you share it. Runs entirely in your browser — the photo is never uploaded.",
    metric: "Runs locally",
  },
  {
    ...
    description:
      "Convert between JPG, PNG, and WebP — including HEIC and TIFF — and crop to a common aspect ratio or your own custom one. Runs locally.",
    metric: "Runs locally",
  },
];
...
export default function Home() {
  usePageTitle(
    "Fixyorio — free tools for the paperwork of life",
    "Free tools for resumes, contracts, and money: ATS resume checker, contract risk checker, compound growth calculator, freelance rate calculator, and quarterly tax calculator. No signup."
  );
  return (
